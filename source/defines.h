...
enum WarnType {WARN_USE_UNSET_LOCAL, WARN_USE_UNSET_GLOBAL, WARN_LOCAL_SAME_AS_GLOBAL, WARN_ALL};	// ***AC 2/4/11 ADDED WarnType

enum WarnMode {WARNMODE_OFF, WARNMODE_OUTPUTDEBUG, WARNMODE_MSGBOX};	// WARNMODE_OFF must be zero.	// ***AC 2/4/11 ADDED WarnMode
