...
WarnMode g_Warn_UseUnsetLocal = WARNMODE_OFF;		// ***AC 2/4/11 ADDED g_Warn_UseUnsetLocal (used by #Warn directive)
WarnMode g_Warn_UseUnsetGlobal = WARNMODE_OFF;		// ***AC 2/4/11 ADDED g_Warn_UseUnsetGlobal (used by #Warn directive)
WarnMode g_Warn_LocalSameAsGlobal = WARNMODE_OFF;	// ***AC 2/4/11 ADDED g_Warn_LocalSameAsGlobal (used by #Warn directive)
